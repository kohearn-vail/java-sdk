Feature: ConferenceCreateOptions
	...
	Then set statusCallbackUrl to http://www.freeclimb.com/statusCallback in ConferenceCreateOptions
	Then check that statusCallbackUrl is http://www.freeclimb.com/statusCallback in ConferenceCreateOptions
	Then set waitUrl to http://www.freeclimb.com/wait in ConferenceCreateOptions
	Then check that waitUrl is http://www.freeclimb.com/wait in ConferenceCreateOptions
