...
public class APIRequesterTest {
	...
	public void canChangeFreeClimbUrl(String newUrl) throws Throwable {
		this.req.setFreeClimbUrl(newUrl);
		assertThat(this.req.getFreeClimbUrl(), is(newUrl));
	}
	...
	public void makeASuccessfulGETStreamRequest() throws Throwable {
		...
		Helper.getMockServer()
				.when(request().withMethod("GET").withPath("/getSuccess").withQueryStringParameters(listQuery))
	...
	public void makeASuccessfulGETRequest() throws Throwable {
		...
		Helper.getMockServer()
				.when(request().withMethod("GET").withPath("/getSuccess").withQueryStringParameters(listQuery))
				.respond(response().withStatusCode(200).withBody("{\"value\":\"EXAMPLE\"}"));
	...
	public void makeASuccessfulGETRequestWithoutAQueryString() throws Throwable {
		Helper.getMockServer().when(request().withMethod("GET").withPath("/getSuccess"))
				.respond(response().withStatusCode(200).withBody("{\"value\":\"EXAMPLE\"}"));
	...
	public void makeAnUnsuccessfulGETRequest() throws Throwable {
		...
		Helper.getMockServer()
				.when(request().withMethod("GET").withPath("/getSuccessFail").withQueryStringParameters(listQuery))
				.respond(response().withStatusCode(400).withBody("{\"status\": 400, \"message\": \"Bad input\"}"));
		...
		} catch (FreeClimbErrorResponseException pere) {
	...
	public void makeASuccessfulPOSTRequest() throws Throwable {
		Helper.getMockServer().when(request().withMethod("POST").withPath("/postSuccess").withBody("{}"))
				.respond(response().withStatusCode(200).withBody("{\"value\":\"EXAMPLE\"}"));
	...
	public void makeASuccessfulPOSTRequestEmptyPayload() throws Throwable {
		Helper.getMockServer().when(request().withMethod("POST").withPath("/postSuccess"))
				.respond(response().withStatusCode(200).withBody("{\"value\":\"EXAMPLE\"}"));
		try {
	...
	public void makeAnUnsuccessfulPOSTRequest() throws Throwable {
		Helper.getMockServer().when(request().withMethod("POST").withPath("/postSuccessFail").withBody("{}"))
				.respond(response().withStatusCode(400).withBody("{\"status\": 400, \"message\": \"BAD INPUT\"}"));
	...
	public void makeAnUnsuccessfulPOSTRequestEmptyPayload() throws Throwable {
		Helper.getMockServer().when(request().withMethod("POST").withPath("/postSuccessFail"))
				.respond(response().withStatusCode(400).withBody("{\"status\": 400, \"message\": \"BAD INPUT\"}"));
	...
	public void makeASuccessfulDELETERequest() throws Throwable {
		Helper.getMockServer().when(request().withMethod("DELETE").withPath("/deleteSuccess"))
	...
	public void makeAnUnsuccessfulDELETERequest() throws Throwable {
		Helper.getMockServer().when(request().withMethod("DELETE").withPath("/deleteSuccessFail"))
				.respond(response().withStatusCode(400).withBody("{\"status\": 400,\"message\": \"A Message\"}"));
