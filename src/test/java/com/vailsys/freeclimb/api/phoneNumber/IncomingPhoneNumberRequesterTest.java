...
public class IncomingPhoneNumberRequesterTest {
        ...
        private String listJson = "{\"total\" : 1, \"start\" : 0, \"end\" : 1, \"page\" : 0, \"numPages\" : 1, \"pageSize\" : 100, \"nextPageUri\" : null, \"incomingPhoneNumbers\" : ["
                        + this.incomingJson + "]}";
        ...
        public void getList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(requester.getPath()))
                                .respond(response().withStatusCode(200).withBody(listJson));
        ...
        public void getFilteredList() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(requester.getPath())
        ...
        public void purchase() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.requester.getPath()))
                                .respond(response().withStatusCode(200).withBody(incomingJson));
        ...
        public void delete() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("DELETE").withPath(requester.getPath() + "/" + id))
                                .respond(response().withStatusCode(204));

                requester.delete(id);

                Helper.getMockServer().verify(request().withMethod("DELETE").withPath(requester.getPath() + "/" + id),
        ...
        public void get() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("GET").withPath(requester.getPath() + "/" + id))
                                .respond(response().withStatusCode(200).withBody(incomingJson));
        ...
        public void modify() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(requester.getPath() + "/" + id))
                                .respond(response().withStatusCode(200).withBody(incomingJson));
