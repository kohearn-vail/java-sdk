...
public class CallingNumberRequesterTest {
        ...
        private String listJson = "{\"total\" : 1, \"start\" : 0, \"end\" : 1, \"page\" : 0, \"numPages\" : 1, \"pageSize\" : 100, \"nextPageUri\" : null, \"callingNumbers\" : ["
        ...
        public void createCallingNumber() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(requester.getPath()))
                                .respond(response().withStatusCode(200).withBody(this.newCallingNumber));
        ...
        public void deleteCallingNumber() throws Throwable {
                ...
                Helper.getMockServer()
                                .verify(request().withMethod("DELETE")
                                                .withPath(this.requester.getPath() + "/" + callingNumberId),
        ...
        public void getCallingNumber() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET")
                                                .withPath(this.requester.getPath() + "/" + callingNumberId))
                                .respond(response().withStatusCode(200).withBody(newCallingNumber));
        ...
        public void updateCallingNumber() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("POST")
                                                .withPath(requester.getPath() + "/" + callingNumberId))
                                .respond(response().withStatusCode(200).withBody(updatedNumber));
