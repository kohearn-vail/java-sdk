...
public class ApplicationsRequesterTest {
        ...
        private static String aTestApplicationList = "{\"total\": 4, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 20, \"nextPageUri\": null, \"applications\": ["
                        + ApplicationsRequesterTest.aTestApplication + "," + ApplicationsRequesterTest.aTestApplication
                        + "," + ApplicationsRequesterTest.aTestApplication + ","
                        + ApplicationsRequesterTest.aTestApplication + "]}";
        ...
        public void getApplicationList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.requester.getPath()))
                                .respond(response().withStatusCode(200)
                                                .withBody(ApplicationsRequesterTest.aTestApplicationList));

                ApplicationList al = this.requester.get();
                ApplicationList orig = new ApplicationList("ACCOUNTID", "AUTHTOKEN",
                                ApplicationsRequesterTest.aTestApplicationList);
        ...
        public void getApplication() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET")
                                                .withPath(this.requester.getPath() + "/" + applicationId))
                                .respond(response().withStatusCode(200)
                                                .withBody(ApplicationsRequesterTest.aTestApplication));
        ...
        public void updateApplication() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("POST")
                                                .withPath(this.requester.getPath() + "/" + applicationId))
                                .respond(response().withStatusCode(200)
                                                .withBody(ApplicationsRequesterTest.anUpdatedTestApplication));
        ...
        public void createApplication() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.requester.getPath())).respond(
