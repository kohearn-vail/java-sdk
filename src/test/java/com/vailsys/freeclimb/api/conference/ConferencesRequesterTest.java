...
public class ConferencesRequesterTest {
        ...
        private static String aTestConferenceList = "{\"total\": 4, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 20, \"nextPageUri\": null, \"conferences\": ["
                        + ConferencesRequesterTest.aTestConference + "," + ConferencesRequesterTest.aTestConference
                        + "," + ConferencesRequesterTest.aTestConference + ","
                        + ConferencesRequesterTest.aTestConference + "]}";
        ...
        public void getConferencesList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.confR.getPath())).respond(
                                response().withStatusCode(200).withBody(ConferencesRequesterTest.aTestConferenceList));

                ConferenceList cl = this.confR.get();
                ConferenceList orig = new ConferenceList("ACCOUNTID", "AUTHTOKEN",
                                ConferencesRequesterTest.aTestConferenceList);
        ...
        public void getConferencesListWithFilters() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(this.confR.getPath())
                                                .withQueryStringParameters(listQuery))
                                .respond(response().withStatusCode(200)
                                                .withBody(ConferencesRequesterTest.aTestConferenceList));
        ...
        public void getConferenceWithConferenceId() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(this.confR.getPath() + "/" + conferenceId))
                                .respond(response().withStatusCode(200)
                                                .withBody(ConferencesRequesterTest.aTestConference));
        ...
        public void updateConference() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("POST").withPath(this.confR.getPath() + "/" + conferenceId))
                                .respond(response().withStatusCode(200)
                                                .withBody(ConferencesRequesterTest.anUpdatedTestConference));
        ...
        public void createConference() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.confR.getPath())).respond(
        ...
        public void createConferenceWithOptions() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.confR.getPath()))
                                .respond(response().withStatusCode(200)
                                                .withBody(ConferencesRequesterTest.aTestConferenceWithOptions));
