...
public class ParticipantsRequesterTest {
        ...
        private static String aTestParticipantList = "{\"total\": 4, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 20, \"nextPageUri\": null, \"participants\": ["
                        + ParticipantsRequesterTest.aTestParticipant + "," + ParticipantsRequesterTest.aTestParticipant
        ...
        public void checkActingAccountId(String accountId) {
                assertThat(this.partR.getActingAccountId(), is(accountId));
        }
        ...
        public void getParticipantsList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.partR.getPath()))
                                .respond(response().withStatusCode(200)
                                                .withBody(ParticipantsRequesterTest.aTestParticipantList));

                ParticipantList pl = this.partR.get();
                ParticipantList orig = new ParticipantList("ACCOUNTID", "AUTHTOKEN",
                                ParticipantsRequesterTest.aTestParticipantList);
        ...
        public void getParticipantsListWithFilters() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(this.partR.getPath())
        ...
        public void getParticipantWithParticipantId() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(this.partR.getPath() + "/" + participantId))
                                .respond(response().withStatusCode(200)
                                                .withBody(ParticipantsRequesterTest.aTestParticipant));
