...
public class MessageRequesterTest {
    ...
    private static String aTestMessageList = "{\"total\": 4, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 20, \"nextPageUri\": null, \"messages\": ["
    ...
    public void getMessage() throws Throwable {
        ...
        Helper.getMockServer().when(request().withMethod("GET").withPath(this.requester.getPath() + "/" + messageId))
                .respond(response().withStatusCode(200).withBody(MessageRequesterTest.aTestMessage));
    ...
    public void getMessageList() throws Throwable {
        Helper.getMockServer().when(request().withMethod("GET").withPath(this.requester.getPath()))
                .respond(response().withStatusCode(200).withBody(MessageRequesterTest.aTestMessageList));
    ...
    public void getMessageListWithFilters() throws Throwable {
        ...
        Helper.getMockServer()
                .when(request().withMethod("GET").withPath(this.requester.getPath())
    ...
    public void createMessage() throws Throwable {
        ...
        Helper.getMockServer().when(request().withMethod("POST").withPath(this.requester.getPath()).withBody(json))
                .respond(response().withStatusCode(201).withBody(MessageRequesterTest.aTestMessage));

        Message m = this.requester.create(from, to, text);

        Helper.getMockServer().verify(request().withMethod("POST").withPath(this.requester.getPath()).withBody(json),
    ...
    public void createMessageWithOptions() throws Throwable {
        ...
        Helper.getMockServer().when(request().withMethod("POST").withPath(this.requester.getPath()).withBody(json))
                .respond(response().withStatusCode(201).withBody(MessageRequesterTest.aTestMessageWithNotificationUrl));
