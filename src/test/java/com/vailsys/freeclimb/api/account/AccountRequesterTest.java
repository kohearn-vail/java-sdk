...
public class AccountRequesterTest {
    ...
    public void create(String accountId, String apiKey, String actingId) throws Throwable {
        requester = new AccountRequester(accountId, apiKey, actingId);
    ...
    public void getAcc() throws Throwable {
        ...
        Helper.getMockServer().when(request().withMethod("GET").withPath(requester.getPath() + "/" + accId))
                .respond(response().withStatusCode(200).withBody(accountJson));
