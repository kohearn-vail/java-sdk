...
public class CallTest {
	...
	public void checkCallAgainstJson() {
		...
		FreeClimbDateFormat.format(this.theCall.getStartTime(), dateString, new FieldPosition(0));
		assertThat((String) jsonMap.get("startTime"), is(dateString.toString()));

		dateString = new StringBuffer();
		FreeClimbDateFormat.format(this.theCall.getConnectTime(), dateString, new FieldPosition(0));
		assertThat((String) jsonMap.get("connectTime"), is(dateString.toString()));

		dateString = new StringBuffer();
		FreeClimbDateFormat.format(this.theCall.getEndTime(), dateString, new FieldPosition(0));
		...
		assertThat((Integer) ((Double) jsonMap.get("connectDuration")).intValue(),
				is(this.theCall.getConnectDuration()));
		...
		com.google.gson.internal.LinkedTreeMap mmm = ((com.google.gson.internal.LinkedTreeMap) jsonMap
				.get("subresourceUris"));
