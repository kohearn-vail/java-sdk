...
public class MembersRequesterTest {
        ...
        private static String testMemberList = "{\"total\": 1, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 1, \"nextPageUri\": null, \"queueMembers\": ["
                        + MembersRequesterTest.testMember + "]}";
        ...
        public void createMembersRequester(String credId, String credAuth, String accountId, String queuePath) {
                ...
                this.memR.setFreeClimbUrl("http://127.0.0.1:" + Helper.getServerPort());
        }
        ...
        public void getMemberList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.memR.getPath()))
                                .respond(response().withStatusCode(200).withBody(MembersRequesterTest.testMemberList));
        ...
        public void getMemberByCallId() throws Throwable {
                ...
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.memR.getPath() + "/" + callId))
        ...
        public void getMemberByFront() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.memR.getPath() + "/Front"))
                                .respond(response().withStatusCode(200).withBody(MembersRequesterTest.testMember));
        ...
        public void dequeueMemberByCallId() throws Throwable {
                String callId = "CAb933917ae0d3547bd65da77a4aa50e0329850401";
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.memR.getPath() + "/" + callId))
                                .respond(response().withStatusCode(200).withBody(MembersRequesterTest.testMember));
