...
public class QueuesRequesterTest {
        ...
        private static String aTestQueueList = "{\"total\": 1, \"start\": 0, \"end\": 0, \"page\": 0, \"numPages\": 1, \"pageSize\": 1, \"nextPageUri\": null, \"queues\": ["
                        + QueuesRequesterTest.aTestQueue + "]}";
        ...
        public void getQueueList() throws Throwable {
                Helper.getMockServer().when(request().withMethod("GET").withPath(this.requester.getPath()))
                                .respond(response().withStatusCode(200).withBody(QueuesRequesterTest.aTestQueueList));
        ...
        public void getQueueById() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("GET").withPath(this.requester.getPath() + "/" + queueId))
                                .respond(response().withStatusCode(200).withBody(QueuesRequesterTest.aTestQueue));
        ...
        public void updateQueue() throws Throwable {
                ...
                Helper.getMockServer()
                                .when(request().withMethod("POST").withPath(this.requester.getPath() + "/" + queueId))
                                .respond(response().withStatusCode(200)
                                                .withBody(QueuesRequesterTest.anUpdatedTestQueue));
        ...
        public void createQueue() throws Throwable {
                Helper.getMockServer().when(request().withMethod("POST").withPath(this.requester.getPath()))
                                .respond(response().withStatusCode(200).withBody(QueuesRequesterTest.aTestQueue));
