 ...
 * updating an IncomingPhoneNumber.
 */
public class IncomingPhoneNumberUpdateOptions {
    /**
     * The alias of the incoming phone number.
     */
    private String alias;
    /**
     * The id of the application to use when a call is placed to this incoming phone
     * number.
     */
    ...
    /**
     * Set the applicationId of the update option to set the applicationId of the
