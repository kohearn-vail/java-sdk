...
/**
 * PhoneNumber is the base class from which all phone number classes that are
 * built to represent objects returned from the FreeClimb API are built upon. A
 * user of the SDK should never directly interact with a PhoneNumber object.
 */
public class PhoneNumber extends FreeClimbCommon {
    /**
