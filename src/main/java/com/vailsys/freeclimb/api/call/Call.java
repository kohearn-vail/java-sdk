...
/**
 * This class represents a FreeClimb Call instance. Call objects are created by
 * the SDK whenever a call instance would be returned by the API; these
 * primarily come from a {@link com.vailsys.freeclimb.api.call.CallsRequester}
 * inside a {@link com.vailsys.freeclimb.api.FreeClimbClient} instance.<br>
 * <br>
 * Calls are immutable and intended only to be used to read information returned
 ...
 */
public class Call extends FreeClimbCommon {
	/**
	 ...
	 * 
	 * @see com.vailsys.freeclimb.api.call.Direction
	 */
	private Direction direction;
	/**
	 * Who/What answered this call, if it was answered at all.
	 * 
	 * @see com.vailsys.freeclimb.api.call.AnsweredBy
	 */
	private AnsweredBy answeredBy;
	/**
	 * If this call was an incoming call to a phone number with Caller ID Lookup
	 ...
	 *
	 * @param json A JSON string representing a FreeClimb Call instance.
	 *
	 * @return A Call object equivalent to the JSON string passed in.
	 * @throws FreeClimbJSONException when the JSON is invalid.
	 */
	public static Call fromJson(String json) throws FreeClimbJSONException {
		try {
	...
	/**
	 * Check if this call equals another. This is done by comparing all fields in
