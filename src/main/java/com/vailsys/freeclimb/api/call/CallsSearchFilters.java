...
public class CallsSearchFilters extends Filters {
	...
	/**
	 * Retrieve the value of the startTime filter as a Java {@link java.util.Date}
	 * object.
	 *
	...
	/**
	 * Retrieve the value of the endTime filter as a Java {@link java.util.Date}
	 * object.
	 *
	...
	/**
	 * Set the from filter for calls that are/were called from the provided number
	 * (search by ANI).
	 * 
	...
	/**
	 * Set the status filter for calls that are in the given state/have the given
	 * status.
	 * 
	 * @see com.vailsys.freeclimb.api.call.CallStatus
	...
	/**
	 * Set the startTime filter to find calls that started after the provided time.
	 * 
	...
	/**
	 * Set the endTime filter to find calls that ended before the provided time.
	 * 
	...
	/**
	 * Set the parentCallId filter to find calls with the provided parentCallId.
	 * 
