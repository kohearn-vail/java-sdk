...
/**
 * This class represents a FreeClimb Member instance. Member objects are created
...
public class Member {
     ...
     *
     * @param json A JSON string representing a FreeClimb Member instance.
     *
     * @return A Member object equivalent to the JSON string passed in.
     * @throws FreeClimbJSONException when the JSON is not valid.
     */
    public static Member fromJson(String json) throws FreeClimbJSONException {
        try {
    ...
    /**
     * Check if this member equals another. This is done by comparing all fields in
     * the member for equality.
     *
