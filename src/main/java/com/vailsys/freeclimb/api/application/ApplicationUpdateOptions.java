...
public class ApplicationUpdateOptions {
    ...
    /**
     * Set the voiceFallbackUrl update option to set the voiceFallbackUrl of the
     * application.
     * 
    ...
    /**
     * Set the callConnectUrl update option to set the callConnectUrl of the
     * application.
     * 
    ...
    /**
     * Set the statusCallbackUrl update option to set the statusCallbackUrl of the
     * application.
     * 
