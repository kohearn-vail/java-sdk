...
/**
 * This class represents a FreeClimb Application instance. Applications objects
 * are created by the SDK whenever an application instance would be returned by
 * the API; these primarily come from a
 ...
 */
public class Application extends FreeClimbCommon {
    /**
    ...
    /**
     * The url FreeClimb will request when a phone number assigned to this
     * application receives a call. Used for inbound calls only.
     */
    private String voiceUrl;
    /**
     * The URL that FreeClimb will request if an error occurs retrieving or
     * executing the PerCL requested by voiceUrl. Used for inbound calls only.
     */
    private String voiceFallbackUrl;
    /**
     * The url that FreeClimb will request informing the result of the outbound
     * request. The status property of the request message specifies if the call was
     * connected or not. This is only used if an applicationId is specified when
     * making an outbound call.
     */
    private String callConnectUrl;
    /**
     * The url that FreeClimb will request when the call ends.
     */
    ...
    /**
     * The URL that FreeClimb will request if an error occurs when making a request
     * to the smsUrl. Used for inbound SMS only.
     */
     ...
     *
     * @param json A JSON string representing a FreeClimb Application instance.
     ...
     */
    public static Application fromJson(String json) throws FreeClimbJSONException {
        try {
    ...
    /**
     * Check if this application equals another. This is done by comparing all the
     * fields in the application for equality.
     *
