...
public class ApplicationCreateOptions extends CommonFields {
    ...
    /**
     * The url that will be requested in the case of an error requesting or
     * executing the voiceUrl PerCL script.
     */
    ...
    /**
     * Set the voiceFallbackUrl create option to set the new application's
     * voiceFallbackUrl property.
     * 
    ...
    /**
     * Set the callConnectUrl create option to set the new application's
     * callConnectUrl property.
     * 
    ...
    /**
     * Set the statusCallbackUrl create option to set the new application's
     * statusCallbackUrl property.
     * 
    ...
    /**
     * Set the smsFallbackUrl create option to set the new application's
     * smsFallbackUrl property.
     * 
