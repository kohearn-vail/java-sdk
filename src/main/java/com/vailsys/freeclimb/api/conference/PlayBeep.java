 ...
 * whether the conference will play a beep when a participant enters or leaves
 * the conference.
 */
public enum PlayBeep {

	/**
	 * This value represents the setting where the conference will beep when a
	 * participant enters or leaves the conference.
	 */
	...
	NEVER,
	/**
	 * This value represents the setting where the conference will sound a tone when
	 * a participant enters the conference, but not on leaving.
	 */
	@SerializedName("entryOnly")
	ENTRY_ONLY,
	/**
	 * This value represents the setting where the conference will sound a tone when
	 * a participant leaves the conference, but not on entering.
	 */
