...
/**
 * This class represents a FreeClimb Participant instance. Participant objects
 * are created by the SDK whenever a participant would be returned by the API;
 * these primarily come from a
 ...
 *
 * @see com.vailsys.freeclimb.api.conference.participant.ParticipantsRequester
 * @see com.vailsys.freeclimb.api.FreeClimbClient
 */
public class Participant extends FreeClimbCommon {
    /**
     ...
     *
     * @param json A JSON string representing a FreeClimb Participant instance.
     *
     ...
     */
    public static Participant fromJson(String json) throws FreeClimbJSONException {
        try {
    ...
    /**
     * Check if this participant equals another. This is done by comparing all
     * fields in the participant for equality.
     *
