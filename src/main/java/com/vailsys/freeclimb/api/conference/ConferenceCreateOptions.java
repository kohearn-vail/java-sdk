...
public class ConferenceCreateOptions extends CommonFields {
	...
	/**
	 * The url FreeClimb checks for a PerCL script to perform against calls waiting
	 ...
	 * 
	 * @param playBeep When the conference should beep.
	 *                 {@link com.vailsys.freeclimb.api.conference.PlayBeep}
	 */
	...
	/**
	 * Set the statusCallbackUrl create option to set the new conference's
