...
/**
 * The APIAccountRequester is the base class for various *Requester classes
 * which each wrap a portion of the FreeClimb API. This class abstracts away the
 ...
 * Specifically this class is used by *Requester classes that have an endpoint
 * under the FreeClimb API /Accounts path but aren't related to the Accounts
 * resource.
 */
