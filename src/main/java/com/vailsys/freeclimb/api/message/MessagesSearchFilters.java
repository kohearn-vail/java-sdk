...
/**
 * Represents the possible fields one can set as filters when retrieving a list
 * of messages.
 */
public class MessagesSearchFilters {
    ...
    /**
     * Only show messages sent at or after this time (GMT), given as YYYY-MM-DD
     * hh:mm:ss.
     */
    private String beginTime;

    /**
     * Only show messages sent at or before this time (GMT), given as YYYY-MM-DD
     * hh:mm:ss.
     */
    private String endTime;

    /**
     * Only show messages with this direction property. Allows filtering for
     * messages sent by FreeClimb or received by FreeClimb.
     */
    ...
    /**
     * Only show messages sent at or after this tim (GMT), given as YYYY-MM-DD
     * hh:mm:ss.
     * 
