...
/**
 * This enum represents the predefined values for the {@code type} field inside
 * a FreeClimb Account instance. It indicates whether an account is in a trial
 * state or a full account.
 */
public enum Type {
    /**
